<div align="center">
  <a href="https://git.io/typing-svg">
    <img
      src="https://readme-typing-svg.herokuapp.com?font=Architects+Daughter&color=%2338C2FF&size=50&center=true&vCenter=true&height=60&width=600&lines=Hi!+I'm+Remiotore+%3C3;"
      alt="Title"></img>
  </a>
</div>
...
**Offensive-security practitioner focused on penetration testing, red teaming, and bug bounty hunting.**

Every single day, I complete a HackTheBox machines to sharpen my skills and push my technical limits.

I'm continuously improving in vulnerability research, binary analysis, and exploit development as I work toward
mastering offensive security.

Follow me on **[`X`](https://x.com/MaeKidd54320)** and **[`HackTheBox`](https://app.hackthebox.com/users/25872)**.
...
<div style="border: 2px solid #22F700; border-radius: 10px; padding: 20px; margin-bottom: 20px;">
  <div align="left" style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px;">
    ...
    <img src="https://img.shields.io/badge/Flask-000000?style=for-the-badge&logo=Flask&color=000000" />
    ...
    <img src="https://img.shields.io/badge/-Elastic-005571?style=flat&logo=elastic&color=000000" />
    <img src="https://img.shields.io/badge/-Kibana-005571?style=flat&logo=kibana&color=000000" />
    <img src="https://img.shields.io/badge/-Logstash-005571?style=flat&logo=logstash&color=000000" />
    <img src="https://img.shields.io/badge/-SQLite-003B57?style=flat&logo=sqlite&color=000000" />
    <img src="https://img.shields.io/badge/-MySQL-4479A1?style=flat&logo=mysql&color=000000" />
...
<details>
  <summary>Intro to Blue Team</summary>
  <ul></ul>
</details>
...
<details>
  <summary>AI and ML Exploitation</summary>
  <ul></ul>
</details>
...
<details>
  ...
  <ul>
    ...
    <li>ARMs Race</li>
    <li>Tear Or Dear</li>
    <li>The Art of Reversing</li>
    <li>Impossible Password</li>
    <li>Eat the Cake!</li>
    <li>Debugme</li>
    <li>Coffee Invocation</li>
    <li>Headache</li>
    <li>Bombs Landed</li>
  </ul>
</details>
...
<details>
  <summary>Hardware Exploitation</summary>
  <ul></ul>
</details>

<details>
  <summary>Quantum Exploitation</summary>
  <ul></ul>
</details>
...
<h2>Project 1: <b>Freqtrade Strategy &amp; Market Analysis</b></h2>

<p><b>Quantitative analysis of OHLCV data and large-scale strategy metadata.</b></p>

<p>
This project focuses on market behavior analysis and automated evaluation of algorithmic trading
strategies built for Freqtrade.
</p>

<h4>OHLCV Analysis (WIP)</h4>
<ul>
  <li>Price action and volume trend analysis</li>
  <li>Indicator-driven market insights</li>
  <li>Statistical summaries and visualizations</li>
</ul>

<h4>Strategy Analysis (WIP)</h4>
<ul>
  <li>Automated processing of public strategies from <a href="https://strat.ninja">Strat.Ninja</a></li>
  <li>Extraction of structural, indicator, and performance metadata</li>
  <li>Generation of a unified strategy dataset for research</li>
</ul>

<b>Extracted Strategy Metadata</b>
<ul>
  <li>Trading mode (Spot / Futures)</li>
  <li>Timeframe</li>
  <li>DCA usage</li>
  <li>Long/Short capability</li>
  <li>Leverage</li>
  <li>Stoploss configuration</li>
  <li>Bias detection (e.g., lookahead bias)</li>
  <li>Profit metrics</li>
  <li>Indicator usage (binary feature columns)</li>
</ul>

<b>Output</b>
<ul>
  <li><code>strategies_metadata.ndjson</code></li>
  <li>One row per strategy, enabling:
    <ul>
      <li>Correlation analysis</li>
      <li>Feature importance studies</li>
      <li>Strategy filtering &amp; comparison</li>
    </ul>
  </li>
</ul>
...
<b>Use Cases</b>
<ul>
  <li>Strategy benchmarking</li>
  <li>Indicator effectiveness research</li>
  <li>Quantitative trading research</li>
</ul>

<h2>Project 2: <b>ccxt-opensearch</b></h2>

<p><b>Market data ingestion, storage, and analytics pipeline using CCXT and OpenSearch.</b></p>

<p>
This project fetches real-time and historical cryptocurrency market data from multiple exchanges via
<b>CCXT</b> and ingests it into <b>OpenSearch</b> for scalable storage, querying, and visualization.
</p>

<b>Key Features</b>
<ul>
  <li>Automated OHLCV data collection (cron-ready)</li>
  <li>Structured time-based indices per exchange, symbol, and date</li>
  <li>OpenSearch Dashboards for exploration and analytics</li>
  <li>Dockerized stack for easy deployment</li>
  <li>Planned integrations:
    <ul>
      <li>TA-Lib indicators</li>
      <li>Indicator-based alerts</li>
...
<ul>
  <li>Python</li>
  <li>CCXT</li>
  <li>OpenSearch &amp; OpenSearch Dashboards</li>
  <li>Docker / Docker Compose</li>
</ul>

<b>Use Cases</b>
<ul>
  <li>Market data warehousing</li>
  <li>Indicator backtesting</li>
  <li>Alerting &amp; monitoring</li>
  <li>Multi-asset analytics at scale</li>
</ul>

<hr>

<h2>Project 3: <b>ccxt-dashboard</b></h2>

<p><b>Interactive Jupyter-based dashboard for multi-asset technical analysis.</b></p>

<p>
This project provides a visual analytics dashboard built with Jupyter Notebook to explore and compare
technical indicators across multiple cryptocurrencies.
</p>

<b>Key Features</b>
<ul>
  <li>Multi-symbol selection (BTC, ETH, ...)</li>
  <li>Interactive time range slider</li>
  <li>OHLC visualization</li>
  <li>Indicator overlays with configurable periods</li>
  <li>Dynamic Y-axis indicator selection</li>
</ul>

<b>Supported Indicators</b>
<ul>
  <li>VAR, STDDEV</li>
  <li>PPO, ROC, MOM</li>
  <li>NATR, RSI, CCI</li>
  <li>EMA</li>
  <li>DX, ADX, PDI, MDI</li>
</ul>
...
<b>Use Cases</b>
<ul>
  <li>Exploratory market analysis</li>
  <li>Indicator comparison</li>
  <li>Strategy research &amp; validation</li>
</ul>
