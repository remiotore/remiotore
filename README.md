<div align="center">
  ...
  <img src="https://readme-typing-svg.herokuapp.com?font=Architects+Daughter&color=%2338C2FF&size=50&center=true&vCenter=true&height=60&width=600&lines=Hi!+I'm+Remiotore+%3C3;" alt="Title"></img>
  </a>
</div>
...
I'm continuously improving in vulnerability research, binary analysis, and exploit development as I work toward mastering offensive security.
...
<details>
  ...
  <ul>
    ...
    <li>[SOLVED] Jerry</li>
    <li>[SOLVED] Sau</li>
    <li>[SOLVED] GoodGames</li>
    <li>[SOLVED] Devvortex</li>
    <li>[SOLVED] Paper</li>
    <li>[SOLVED] Writeup</li>
    <li>[SOLVED] Precious</li>
    <li>[SOLVED] Driver</li>
    <li>[SOLVED] BoardLight</li>
    <li>[SOLVED] Cicada</li>
    <li>[SOLVED] TwoMillion</li>
    <li>[SOLVED] SteamCloud</li>
    <li>[SOLVED] Certified</li>
    <li>[SOLVED] Administrator</li>
  </ul>
...
<details>
  ...
  <ul>
    <li>[SOLVED] Cicada</li>
    <li>[SOLVED] EscapeTwo</li>
    <li>[SOLVED] Support</li>
    <li>[SOLVED] Timelapse</li>
    <li>[SOLVED] Return</li>
    <li>[SOLVED] Sauna</li>
    <li>[SOLVED] Administrator</li>
    <li>[SOLVED] Authority</li>
    <li>[SOLVED] Escape</li>
    <li>[SOLVED] Scrambled</li>
    <li>[SOLVED] StreamIO</li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    <li>[SOLVED] OnlyHacks</li>
    <li>[SOLVED] Cursed Stale Policy</li>
    <li>[SOLVED] Testimonial</li>
    <li>[SOLVED] HauntMart</li>
    <li>[SOLVED] GateCrash</li>
    <li>[SOLVED] ProxyAsAService</li>
    <li>ApacheBlaze</li>
    <li>Passman</li>
...
<details>
  ...
  <ul>
    <li>[SOLVED] Questionnaire</li>
    <li>[SOLVED] Mathematricks</li>
    <li>racecar</li>
    <li>El Pipo</li>
    <li>El Teteo</li>
    <li>El Mundo</li>
